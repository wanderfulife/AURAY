...
const pageTitle = ref('Auray'); // Browser tab title
...
Bonjour,<p> pour mieux connaître les usagers de la gare, la Ville d’Auray,<p> AQTA, la Région Bretagne et la SNCF souhaiteraient en savoir plus sur votre déplacement en cours.<p> Auriez-vous quelques secondes à nous accorder ? 
